...
class Footer extends Component {
  ...
  render() {
    ...
    return  <div className={style}>
              <div className='copy'>
                Developed by <a href='https://github.com/loverajoel' target='_blank' onClick={this._handleClick.bind(this, '@loverajoel')}>@loverajoel</a> / Designed by <a href='https://dribbble.com/curva' target='_blank' onClick={this._handleClick.bind(this, '@aschelstraete')}>@aschelstraete</a> / <a href='https://github.com/loverajoel/magicplaylist' onClick={this._handleClick.bind(this, 'github')} target='_blank'>Source Code</a> / <a href='https://twitter.com/magicplaylistco' onClick={this._handleClick.bind(this, 'twitter')} target='_blank'>@magicplaylistco</a></div>
